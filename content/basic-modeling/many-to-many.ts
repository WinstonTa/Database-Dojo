...

  {
    ...
    solution: {
      ...
      diagram: {
        ...
        rows: 3,
        entities: [
          { id: "child", name: "Child", col: 0, row: 1, attributes: ["name : string", "address : string", "born : date"] },
          { id: "toy", name: "Toy", col: 1, row: 1, attributes: ["name : string"] },
        ],
        associations: [
          {
            from: "child",
            ...
            fromMult: "*",
            toMult: "*",
            associationClass: { name: "WishListItem", attributes: ["year : int"], side: "above" },
          },
          {
            from: "child",
            to: "toy",
            ...
            fromMult: "*",
            toMult: "*",
            associationClass: { name: "Delivery", attributes: ["year : int", "naughty : bool"], side: "below" },
          },
        ],
      },
      diagramCaption: "Two association classes on the same pair: what was wished, and what was delivered.",
    },
  },
];
